---
title: "GIS e Análise Espacial aplicada às Ciências Sociais"
subtitle: "Aula 01: "
...
output:
  xaringan::moon_reader:
    css: ["css/rladies-fonts.css", "css/rladies.css"]
    lib_dir: libs
    nature:
...
```{r setup, include=FALSE, echo=FALSE, eval=FALSE, warning=FALSE, message=FALSE, out.width="100%"}
...
img1_path <- url("https://retaoliveira.github.io/GIS_social_sciences/docs/img/logo.svg")
#knitr::opts_chunk$set(comment=NA, fig.width=6, fig.height=6))
#knitr::include_graphics(img1_path, error = FALSE, dpi=100)
#img1_path
```
